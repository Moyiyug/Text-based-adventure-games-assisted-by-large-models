...
ROWS: list[dict] = [
    {
        ...
        "对自由文本中与证据矛盾的内容勿强行当作事实承认（见 GM 层与回合提示）。"
        + META_BLOCK
    ...
    },
    {
        ...
        "可对玩家意图做适度叙事桥接（误解/听错/比喻等），见 GM 层。"
        + META_BLOCK
    ...
    },
    {
        ...
        "layer": "gm",
        "applicable_mode": "strict",
        "template_text": "【GM 层】保持克制、清晰的裁定语气；选项须具体可执行、与检索证据及 state 一致，避免多数选项同为泛泛「继续观察」。战斗/检定若未实现可简化为叙事后果。\n"
        "自由输入与点选同等对待：须回应输入，但**勿**将明显违背设定或证据的玩家陈述当作已发生的事实写入正史；可用 NPC 质疑、环境反馈或选项引导玩家回到可信行动。\n"
        "单轮叙事宜紧凑（若干短段即可），选项文案宜短、一行一条。",
    },
    {
        "name": "gm_voice_creative",
        "layer": "gm",
        "applicable_mode": "creative",
        "template_text": "【GM 层】语气可更生动，但仍给出清晰、可执行的选项；避免空泛套话。须回应玩家输入并推进局面，避免与上一轮 GM 正文大段重复。\n"
        "对自由文本可在合理前提下适度共情：可用误解、听错、比喻等**桥接**玩家意图再分叉，仍勿与检索核心事实硬拗。\n"
        "单轮不宜过长；选项每条一行、点到为止。",
    },
    {
